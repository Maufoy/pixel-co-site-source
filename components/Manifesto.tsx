      ...
      <div className="max-w-[1440px] mx-auto px-[34px] lg:px-[58px]">
        <div className="grid grid-cols-1 lg:grid-cols-[480px_1fr] gap-12 lg:gap-24 items-start">
          ...
          >
            ...
            <p
              className="text-[#616059] mt-6 max-w-[280px]"
          ...
          >
            <p
              className="text-[#F8F7F6] font-light"
              style={{
            ...
            >
              ...
              Vendemos clareza sobre o que está represando o crescimento do seu negócio —
            ...
            <motion.div
              ...
              className="mt-8 pt-8 border-t border-[#3D3C38] flex items-center gap-4"
            >
              <span
                className="w-8 h-px bg-[#00D4FF]"
              />
              <span className="text-[#616059] text-[11px] font-semibold uppercase tracking-widest">
